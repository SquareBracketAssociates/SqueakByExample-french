...
mettre la \ct{Boolean} dans la cat\'egorie \scatind{Kernel-Objects}.
...
identifie la m\'ethode de la classe \ct{StringTest} que nous
\'ecrivons dans le livre \ct{StringTest>>>#testShout}).
...
Nous verrons le d\'ebogueur nomm\'e \ind{Debugger} et sa
fonctionnalit\'e dans \charef{env}.
...
configurer notre machine \`a test % testing machinery
...
\menu{converting}. \`A la place du patron de cr\'ation de m\'ethode,
