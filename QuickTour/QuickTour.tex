...
\item La \emphind{machine virtuelle} (agr\'eg\'e en VM pour
  ...
  avez par exemple l'icone de la machine virtuelle pour le syst\`eme \macosx: \textit{\sq 3.8.15beta1U.app}.
...
importants de \sq (voir \figref{tools}). Faire un glisser-déposer de l'icône \ind{Transcript} puis l'icône \ind{Workspace}.
