...
Pour ces situations, elle est censée initialiser et ouvrir une connexion vers la base de données ou compiler du code source avant l'évaluation des tests.
...
\item Exécutez les tests en utilisant l'évaluateur de tests \sunit (dans \toolsflap).
