...
\`a diff\'erentes impl\'ementations d'une m\^eme abstraction de c\oe{}xister.
...
Toutes les m\'ethodes sont \subind{m\'ethode}{publique}{}s~\footnote{En fait, presque toute.  En \squeak, des m\'ethodes dont les s\'electeurs commencent par
...
\st la pseudo-variable \self repr\'esente le receveur du message. En \ind{Java}, on utilise le mot-cl\'e \ct{this}.
...
h\'erit\'ees ou non, est bas\'ee sur l'\subpvind{self}{envoi} \`a
\self.

Comment l'envoi \`a \self diff\`ere de celle avec \super?
Comme \self, \super repr\'esente le receveur du message.
La seule diff\'erence est dans la méthode de \subind{méthode}{recherche}.
...
par nos cinq r\`egles: les variables \subind{variable}{partagée}{}s.
