...
\ct{factorial}~\footnote{En anglais, factoriel.}
...
\important{Ne fais rien que tu ne peux d\'el\'eguer \`a quelqu'un d'autre. (Don't do anything that you can push off onto someone else.)}
...
\important{Ne laissez jamais personne d'autre jouer avec vos donn\'ees. (Don't let anyone else play with your data.)}
...
\important{Renvoyez une valeur seulement quand votre objet exp\'editeur en a l'usage. (Return a value only when you intend for the sender to use the value.)}
