...
classes \clsind{Stream} sont des sous-classes de \clsind{PositionableStream}.
...
stream next.        --> $a    "le flux est a la position juste apres a"
stream skip: 3.                           "le flux est apres d"
stream position.  -->   4
stream skip: -2.                          "le flux est apres b"
stream position.  --> 2
stream reset.
stream position.  --> 0
stream skipTo: $e.                      "le flux est apres e"
stream next.        --> $f
