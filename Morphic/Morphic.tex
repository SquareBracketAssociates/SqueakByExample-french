...
%% Version: 13642
%% Last-Updated: Fri Dec 21 16:28:36 2007 (3600 CET)
%%           By: Martial Boniou
%%     Update #: 733
%% URL: https://www.iam.unibe.ch/scg/svn_repos/SqueakByExample/FrenchBook/Morphic/Morphic.tex
%% Keywords: 
%% Compatibility: 
%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Nous partons ici du principe que le nom du morph en \ct{String}.
...
\texttt{Control} enfonc\'ee. Vous obtenez ainsi un menu~\footnote{Vous
  ...
  menu.}. Sel\'ectionnez \menu{embed into \go Ellipse}. Maintenant
...
trouve sous le curseur, elle envoie le message \ct{containsPoint:}
...
retourne un tableau de rectangles comprennent les parties de \ct{r1}
exclus de \ct{r2}. 
...
positivement. Si tous les morphs retourne \ct{false}, Morphic entame
une op\'eration de
...
Notez aussi qu'une fois qu'un morph g\`ere les \ind{\'ev\'enements souris}, vous ne pouvez plus l'attraper avec la souris pour le
d\'eplacer.
...
\subsection{Les int\'eracteurs} %interactors
...
%ajout
de coordonn\'ees
retourn\'ee par la m\'ethode \ct{faceX} 
%ajout
...
Vous rencontrerez souvent cette utilisation de la m\'ethode \ct{perform:}.
...
%ajout
et al\'eatoirement (avec le message \ct{atRandom})
...
\begin{itemize}
  ...
  \item d\'eriver la classe d'un morph et red\'efinir ses
    m\'ethodes-cl\'e telles que \ct{initialize} et \ct{drawOn:};
...
%martial: ajout a signaler a andrew
  \item explorer les m\'ethodes graphiques des diff\'erents canevas,
    instances des sous-classes de \ct{Canvas} ou de la classe
    elle-m\^eme pour exploiter leurs ressources pour le dessin des morphs.
\end{itemize}
