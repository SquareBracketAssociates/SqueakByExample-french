...
\short{b} (pour \emph{browse} \cad parcourir \`a l'aide du navigateur de classe) via le nom de la classe ou \short{f} dans le panneau de navigation des cat\'egories de classes.
